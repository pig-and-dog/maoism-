...
*****点击“view code”浏览文件目录****   
 **说明**：   
 此项目复制于其他github项目，非个人制作，请勿用于非法用途。  如果网址打不开或者没反应请使用魔法上网。外文网页建议配合浏览器插件翻译，比如插件twp,推荐使用firefox或者chrome浏览器。如果点击链接没反应，请多等一会，或者换节点。       
 **须知**：   
...
小白网络加速器使用教程： https://github.com/pig-and-dog/dreams   
